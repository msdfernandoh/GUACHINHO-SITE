...
describe("Plataforma SaaS Master",()=>{
 ...
 it("bloqueia o shell Platform fora do PLATFORM_HOST",()=>{expect(proxy).toContain('path.startsWith("/platform/")');expect(proxy).toContain("return platformRouteUnavailableResponse()");});
