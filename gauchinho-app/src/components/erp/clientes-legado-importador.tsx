...
export function ClientesLegadoImportador({ regras, participantes, historico }: { regras: Regra[]; participantes: Participante[]; historico: Historico[] }) {
