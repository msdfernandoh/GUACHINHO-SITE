...
export function ErpSidebar({ config, empresaNome }: { config: ErpSistemaConfig; empresaNome: string }) {
  ...
  const icons = { clientes: Users, consultores: BriefcaseBusiness, lances: TicketCheck, sorteios: Building2, "regras-comissao": Settings2, "repasse-franquia": BadgeDollarSign } as const;
  return (
