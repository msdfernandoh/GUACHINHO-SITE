    ...
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/75 p-4 sm:items-center">
      ...
      >
        ...
        <div>
          ...
          <Input required value={nome} onChange={(e) => onNome(e.target.value)} className="mt-1 bg-slate-950" />
        </div>
        <div>
        ...
        <div>
          ...
          <Input value={cidade} onChange={(e) => onCidade(e.target.value)} className="mt-1 bg-slate-950" />
        </div>
        <div>
