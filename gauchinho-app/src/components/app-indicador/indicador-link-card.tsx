...
export function IndicadorLinkCard({ url }: { url: string }) {
  ...
  return <section className="mt-6 rounded-2xl border border-amber-400/30 bg-amber-400/10 p-4">
    <div className="flex gap-3"><span className="mt-0.5 rounded-xl bg-amber-400 p-2 text-zinc-950"><Link2 className="h-5 w-5" /></span><div><h2 className="font-black">Meu link de indicação</h2><p className="mt-1 text-sm text-zinc-300">Envie este link. Todo cadastro por ele fica vinculado a você.</p></div></div>
