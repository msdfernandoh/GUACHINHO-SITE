...
export function CasosSucessoPublicClient({ casos, simuladorHref, whatsappHref }: Props) {
  ...
  return (
    <>
      <ConteudoViewTracker tipo_evento="caso_sucesso_visualizado" entidade_tipo="lista" />
