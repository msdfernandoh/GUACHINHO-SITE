  ...
  return (
    <button
      className={cn(
        ...
        variant === "default" &&
          "bg-zinc-900 text-white hover:bg-zinc-800 disabled:bg-zinc-800 disabled:text-zinc-400 dark:bg-amber-500 dark:text-zinc-950 dark:hover:bg-amber-400 dark:disabled:bg-zinc-700 dark:disabled:text-zinc-500",
        variant === "outline" &&
